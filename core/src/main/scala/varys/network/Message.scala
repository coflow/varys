...
private[varys] class MessageChunkHeader(
    val typ: Long,
    val id: Int,
    val totalSize: Int,
    val chunkSize: Int,
...
private[varys] class MessageChunk(val header: MessageChunkHeader, val buffer: ByteBuffer) {
...
private[varys] abstract class Message(val typ: Long, val id: Int) {
...
private[varys] class BufferMessage(id_ : Int, val buffers: ArrayBuffer[ByteBuffer], var ackId: Int) 
...
private[varys] object MessageChunkHeader {
  val HEADER_SIZE = 40 
