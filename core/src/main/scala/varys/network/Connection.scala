...
private[varys] class SendingConnection(val address: InetSocketAddress, selector_ : Selector,
...
private[varys] class ReceivingConnection(channel_ : SocketChannel, selector_ : Selector) 
